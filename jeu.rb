class Personne
  ...
  def subit_attaque(degats_recus)
    ...
    puts nom + " perd #{degats_recus} points de vie"
...
class Joueur < Personne
  ...
  def degats
    ...
    return rand(10..25) + @degats_bonus
  ...
  def soin
    ...
    @points_de_vie += rand(15..30)
    puts nom + " prend une potion de soin"
  ...
  def ameliorer_degats
    ...
    puts nom + " concentre son attaque"
    @degats_bonus += rand(1..10)
